/* ─────────────────────────────────────────────
 *  client-config.ts – KRZ Karosserie Reparatur Zentrum
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KRZ',
        fullName: 'KRZ Karosserie Reparatur Zentrum',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@karosserie-zentrum.de',
        phone: '+49 176 22945273',
        phoneDisplay: '+49 176 22945273',
        address: 'Bornmoor 1, 22525 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Bornmoor%201%2C%2022525%20Hamburg',
    },

    social: {
        facebook: 'http://www.karosserie-zentrum.de/',
        instagram: '#',
    },

    seo: {
        title: 'KRZ Karosserie Reparatur Zentrum | Karosseriewerkstatt Hamburg',
        description: 'KRZ Karosserie Reparatur Zentrum – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (43 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KRZ Karosserie Reparatur Zentrum', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KRZ Karosserie Reparatur Zentrum – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 43 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'KRZ Karosserie Reparatur Zentrum – Hamburg',
    },

    stats: [
        { value: '43+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'KRZ Karosserie Reparatur Zentrum steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
