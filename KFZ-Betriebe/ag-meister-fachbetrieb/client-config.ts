/* ─────────────────────────────────────────────
 *  client-config.ts – AG Meister-Fachbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AG',
        fullName: 'AG Meister-Fachbetrieb',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@agmeisterfachbetrieb.de',
        phone: '+49 40 54007175',
        phoneDisplay: '+49 40 54007175',
        address: 'Doerriesweg 4, 22525 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Doerriesweg%204%2C%2022525%20Hamburg',
    },

    social: {
        facebook: 'https://www.agmeisterfachbetrieb.de/',
        instagram: '#',
    },

    seo: {
        title: 'AG Meister-Fachbetrieb | Karosseriewerkstatt Hamburg',
        description: 'AG Meister-Fachbetrieb – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (23 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['AG Meister-Fachbetrieb', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'AG Meister-Fachbetrieb – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 23 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'AG Meister-Fachbetrieb – Hamburg',
    },

    stats: [
        { value: '23+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'AG Meister-Fachbetrieb steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
