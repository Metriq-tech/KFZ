/* ─────────────────────────────────────────────
 *  client-config.ts – Auto Werkstatt
...
export const clientConfig: ClientConfig = {
    ...
    contact: {
        ...
        phone: '',
        phoneDisplay: '',
        address: 'Weg Großlohe 66, 22143 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Weg%20Gro%C3%9Flohe%2066%2C%2022143%20Hamburg',
    },
    ...
    seo: {
        title: 'Auto Werkstatt | Autowerkstatt Hamburg',
        description: 'Auto Werkstatt – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (6 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Auto Werkstatt', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Auto Werkstatt – Autowerkstatt Hamburg',
    ...
    hero: {
        ...
        heroImageAlt: 'Auto Werkstatt – Hamburg',
    },
    ...
    about: {
        ...
        description: 'Auto Werkstatt ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
