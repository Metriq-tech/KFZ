/* ─────────────────────────────────────────────
 *  client-config.ts – Lackdocs Hamburg GmbH
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'L',
        brandName: 'LACKDOCS',
        fullName: 'Lackdocs Hamburg GmbH',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@lackdocs-hamburg.de',
        phone: '+49 40 30067370',
        phoneDisplay: '+49 40 30067370',
        address: 'Eiffestraße 420, 20537 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Eiffestra%C3%9Fe%20420%2C%2020537%20Hamburg',
    },

    social: {
        facebook: 'http://www.lackdocs-hamburg.de/',
        instagram: '#',
    },

    seo: {
        title: 'Lackdocs Hamburg GmbH | Karosseriewerkstatt Hamburg',
        description: 'Lackdocs Hamburg GmbH – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (187 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Lackdocs Hamburg GmbH', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Lackdocs Hamburg GmbH – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 187 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Lackdocs Hamburg GmbH – Hamburg',
    },

    stats: [
        { value: '187+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Lackdocs Hamburg GmbH steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
