/* ─────────────────────────────────────────────
 *  client-config.ts – K&S KFZ Meisterwerkstatt & Gutachtenerstellung
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'K&S',
        fullName: 'K&S KFZ Meisterwerkstatt & Gutachtenerstellung',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'kontakt@ks-meisterwerkstatt.de',
        phone: '+49 176 59725952',
        phoneDisplay: '+49 176 59725952',
        address: 'Stresemannstraße 250, 22769 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Stresemannstra%C3%9Fe%20250%2C%2022769%20Hamburg',
    },

    social: {
        facebook: 'https://kskfzmeister.de/',
        instagram: '#',
    },

    seo: {
        title: 'K&S KFZ Meisterwerkstatt & Gutachtenerstellung | Autowerkstatt Hamburg',
        description: 'K&S KFZ Meisterwerkstatt & Gutachtenerstellung – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (27 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['K&S KFZ Meisterwerkstatt & Gutachtenerstellung', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'K&S KFZ Meisterwerkstatt & Gutachtenerstellung – Autowerkstatt Hamburg',
    ...
    hero: {
        ...
        heroImageAlt: 'K&S KFZ Meisterwerkstatt & Gutachtenerstellung – Hamburg',
    },
    ...
    about: {
        ...
        description: 'K&S KFZ Meisterwerkstatt & Gutachtenerstellung ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
