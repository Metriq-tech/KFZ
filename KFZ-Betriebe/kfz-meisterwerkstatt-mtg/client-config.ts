/* ─────────────────────────────────────────────
 *  client-config.ts – Kfz Meisterwerkstatt MTG
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ',
        fullName: 'Kfz Meisterwerkstatt MTG',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@auto-mtg.de',
        phone: '+49 40 7641770',
        phoneDisplay: '+49 40 7641770',
        address: 'Winsener Str. 116, 21077 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Winsener%20Str.%20116%2C%2021077%20Hamburg',
    },

    social: {
        facebook: 'http://www.auto-mtg.de/',
        instagram: '#',
    },

    seo: {
        title: 'Kfz Meisterwerkstatt MTG | Autowerkstatt Hamburg',
        description: 'Kfz Meisterwerkstatt MTG – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (65 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Kfz Meisterwerkstatt MTG', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Kfz Meisterwerkstatt MTG – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 65 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Kfz Meisterwerkstatt MTG – Hamburg',
    },

    stats: [
        { value: '65+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Kfz Meisterwerkstatt MTG ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
