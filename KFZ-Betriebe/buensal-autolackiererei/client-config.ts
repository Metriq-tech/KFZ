/* ─────────────────────────────────────────────
 *  client-config.ts – BünSal Autolackiererei
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'B',
        brandName: 'BÜNSAL',
        fullName: 'BünSal Autolackiererei',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'babacan-salim@gmx.de',
        phone: '+49 40 75666200',
        phoneDisplay: '+49 40 75666200',
        address: 'König-Georg-Deich 2, 21107 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=K%C3%B6nig-Georg-Deich%202%2C%2021107%20Hamburg',
    },

    social: {
        facebook: 'https://www.autolackiererei-buensal.de/',
        instagram: '#',
    },

    seo: {
        title: 'BünSal Autolackiererei | Karosseriewerkstatt Hamburg',
        description: 'BünSal Autolackiererei – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (58 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['BünSal Autolackiererei', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'BünSal Autolackiererei – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 58 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'BünSal Autolackiererei – Hamburg',
    },

    stats: [
        { value: '58+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'BünSal Autolackiererei steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
