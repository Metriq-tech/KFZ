/* ─────────────────────────────────────────────
 *  client-config.ts – Auto Technik Wandsbek
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AUTO',
        fullName: 'Auto Technik Wandsbek',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@autotechnik-wandsbek.de',
        phone: '+49 40 28571176',
        phoneDisplay: '+49 40 28571176',
        address: 'Usedomstraße 14, 22047 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Usedomstra%C3%9Fe%2014%2C%2022047%20Hamburg',
    },

    social: {
        facebook: 'https://autotechnikwandsbek.de/',
        instagram: '#',
    },

    seo: {
        title: 'Auto Technik Wandsbek | Autowerkstatt Hamburg',
        description: 'Auto Technik Wandsbek – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (257 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Auto Technik Wandsbek', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Auto Technik Wandsbek – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 257 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Auto Technik Wandsbek – Hamburg',
    },

    stats: [
        { value: '257+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Auto Technik Wandsbek ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
