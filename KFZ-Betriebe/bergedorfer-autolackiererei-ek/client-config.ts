/* ─────────────────────────────────────────────
 *  client-config.ts – Bergedorfer Autolackiererei e.K.
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'B',
        brandName: 'BERGEDORFE',
        fullName: 'Bergedorfer Autolackiererei e.K.',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'murat@bal-hamburg.de',
        phone: '+49 40 7217258',
        phoneDisplay: '+49 40 7217258',
        address: 'Kurt-A.-Körber-Chaussee 107-109, 21033 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Kurt-A.-K%C3%B6rber-Chaussee%20107-109%2C%2021033%20Hamburg',
    },

    social: {
        facebook: 'http://www.bal-hamburg.de/',
        instagram: '#',
    },

    seo: {
        title: 'Bergedorfer Autolackiererei e.K. | Autowerkstatt Hamburg',
        description: 'Bergedorfer Autolackiererei e.K. – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.7 von 5 Sternen (80 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Bergedorfer Autolackiererei e.K.', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Bergedorfer Autolackiererei e.K. – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 80 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Bergedorfer Autolackiererei e.K. – Hamburg',
    },

    stats: [
        { value: '80+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Bergedorfer Autolackiererei e.K. ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
