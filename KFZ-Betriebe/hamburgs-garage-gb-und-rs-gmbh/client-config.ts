/* ─────────────────────────────────────────────
 *  client-config.ts – Hamburgs GaRage G.B. & R.S. GmbH
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'H',
        brandName: 'HAMBURGS',
        fullName: 'Hamburgs GaRage G.B. & R.S. GmbH',
    ...
    contact: {
        ...
        phone: '+49 40 407173',
        phoneDisplay: '+49 40 407173',
        address: 'Osterstraße 62-64, 20259 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Osterstra%C3%9Fe%2062-64%2C%2020259%20Hamburg',
    },

    social: {
        facebook: 'http://www.hamburgsgarage.de/',
        instagram: '#',
    },

    seo: {
        title: 'Hamburgs GaRage G.B. & R.S. GmbH | Autowerkstatt Hamburg',
        description: 'Hamburgs GaRage G.B. & R.S. GmbH – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.7 von 5 Sternen (92 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Hamburgs GaRage G.B. & R.S. GmbH', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Hamburgs GaRage G.B. & R.S. GmbH – Autowerkstatt Hamburg',
    ...
    hero: {
        ...
        heroImageAlt: 'Hamburgs GaRage G.B. & R.S. GmbH – Hamburg',
    },
    ...
    about: {
        ...
        description: 'Hamburgs GaRage G.B. & R.S. GmbH ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
