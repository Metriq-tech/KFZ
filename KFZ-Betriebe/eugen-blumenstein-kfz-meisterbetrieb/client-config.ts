/* ─────────────────────────────────────────────
 *  client-config.ts – Eugen Blumenstein Kfz-Meisterbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'E',
        brandName: 'EUGEN',
        fullName: 'Eugen Blumenstein Kfz-Meisterbetrieb',
    ...
    contact: {
        ...
        phone: '',
        phoneDisplay: '',
        address: 'Buschwerder Hauptdeich, 21107 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Buschwerder%20Hauptdeich%2C%2021107%20Hamburg',
    },
    ...
    seo: {
        title: 'Eugen Blumenstein Kfz-Meisterbetrieb | Autowerkstatt Hamburg',
        description: 'Eugen Blumenstein Kfz-Meisterbetrieb – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.7 von 5 Sternen (12 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Eugen Blumenstein Kfz-Meisterbetrieb', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Eugen Blumenstein Kfz-Meisterbetrieb – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 12 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Eugen Blumenstein Kfz-Meisterbetrieb – Hamburg',
    },

    stats: [
        { value: '12+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Eugen Blumenstein Kfz-Meisterbetrieb ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
