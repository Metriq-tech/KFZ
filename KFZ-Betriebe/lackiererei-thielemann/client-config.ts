/* ─────────────────────────────────────────────
 *  client-config.ts – Lackiererei Thielemann
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'L',
        brandName: 'LACKIERERE',
        fullName: 'Lackiererei Thielemann',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@lackiererei-thielemann.de',
        phone: '+49 40 5510102',
        phoneDisplay: '+49 40 5510102',
        address: 'Sperberhorst 8A, 22459 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Sperberhorst%208A%2C%2022459%20Hamburg',
    },

    social: {
        facebook: 'http://www.lackiererei-thielemann.de/',
        instagram: '#',
    },

    seo: {
        title: 'Lackiererei Thielemann | Karosseriewerkstatt Hamburg',
        description: 'Lackiererei Thielemann – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (125 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Lackiererei Thielemann', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Lackiererei Thielemann – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 125 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Lackiererei Thielemann – Hamburg',
    },

    stats: [
        { value: '125+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Lackiererei Thielemann steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
