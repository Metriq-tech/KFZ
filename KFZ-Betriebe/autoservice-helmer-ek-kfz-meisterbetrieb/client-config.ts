/* ─────────────────────────────────────────────
 *  client-config.ts – AutoService-Helmer e.K. KFZ-Meisterbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AUTOSERVIC',
        fullName: 'AutoService-Helmer e.K. KFZ-Meisterbetrieb',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'w.helmer@autoservice-helmer.de',
        phone: '+49 40 38652183',
        phoneDisplay: '+49 40 38652183',
        address: 'Osterrade 29, 21031 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Osterrade%2029%2C%2021031%20Hamburg',
    },

    social: {
        facebook: 'http://autoservice-helmer.de/',
        instagram: '#',
    },

    seo: {
        title: 'AutoService-Helmer e.K. KFZ-Meisterbetrieb | Autowerkstatt Hamburg',
        description: 'AutoService-Helmer e.K. KFZ-Meisterbetrieb – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (158 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['AutoService-Helmer e.K. KFZ-Meisterbetrieb', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'AutoService-Helmer e.K. KFZ-Meisterbetrieb – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 158 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'AutoService-Helmer e.K. KFZ-Meisterbetrieb – Hamburg',
    },

    stats: [
        { value: '158+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'AutoService-Helmer e.K. KFZ-Meisterbetrieb ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
