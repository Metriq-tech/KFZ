/* ─────────────────────────────────────────────
 *  client-config.ts – Holger Hansen KFZ-Meisterbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'H',
        brandName: 'HOLGER',
        fullName: 'Holger Hansen KFZ-Meisterbetrieb',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'kfz@holgerhansen.de',
        phone: '+49 40 3902046',
        phoneDisplay: '+49 40 3902046',
        address: 'Amalia-Rodrigues-Weg 14, 22761 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Amalia-Rodrigues-Weg%2014%2C%2022761%20Hamburg',
    },

    social: {
        facebook: 'http://www.holgerhansen.de/',
        instagram: '#',
    },

    seo: {
        title: 'Holger Hansen KFZ-Meisterbetrieb | Autowerkstatt Hamburg',
        description: 'Holger Hansen KFZ-Meisterbetrieb – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (92 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Holger Hansen KFZ-Meisterbetrieb', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Holger Hansen KFZ-Meisterbetrieb – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 92 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Holger Hansen KFZ-Meisterbetrieb – Hamburg',
    },

    stats: [
        { value: '92+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Holger Hansen KFZ-Meisterbetrieb ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
