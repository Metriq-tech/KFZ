/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ-Meisterbetrieb A-B GmbH
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        ...
        fullName: 'KFZ-Meisterbetrieb A-B GmbH',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@kfzab.de',
        phone: '+49 40 28668000',
        phoneDisplay: '+49 40 28668000',
        address: 'Kornbergstraße 1, 22041 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Kornbergstra%C3%9Fe%201%2C%2022041%20Hamburg',
    },

    social: {
        facebook: 'https://kfzab.de/',
        instagram: '#',
    },

    seo: {
        title: 'KFZ-Meisterbetrieb A-B GmbH | Autowerkstatt Hamburg',
        description: 'KFZ-Meisterbetrieb A-B GmbH – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (11 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ-Meisterbetrieb A-B GmbH', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ-Meisterbetrieb A-B GmbH – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 11 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ-Meisterbetrieb A-B GmbH – Hamburg',
    },
    ...
    about: {
        ...
        description: 'KFZ-Meisterbetrieb A-B GmbH ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
