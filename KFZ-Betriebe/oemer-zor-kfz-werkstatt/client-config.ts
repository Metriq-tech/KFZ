/* ─────────────────────────────────────────────
 *  client-config.ts – Ömer Zor Kfz-Werkstatt
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'Ö',
        brandName: 'ÖMER',
        fullName: 'Ömer Zor Kfz-Werkstatt',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: '',
        phone: '+49 176 31080259',
        phoneDisplay: '+49 176 31080259',
        address: 'Pappelallee 8, 22089 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Pappelallee%208%2C%2022089%20Hamburg',
    },
    ...
    seo: {
        title: 'Ömer Zor Kfz-Werkstatt | Autowerkstatt Hamburg',
        description: 'Ömer Zor Kfz-Werkstatt – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (359 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Ömer Zor Kfz-Werkstatt', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Ömer Zor Kfz-Werkstatt – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 359 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Ömer Zor Kfz-Werkstatt – Hamburg',
    },

    stats: [
        { value: '359+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Ömer Zor Kfz-Werkstatt ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
