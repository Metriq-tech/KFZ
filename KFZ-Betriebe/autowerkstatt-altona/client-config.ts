/* ─────────────────────────────────────────────
 *  client-config.ts – Autowerkstatt Altona
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        ...
        fullName: 'Autowerkstatt Altona',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@autoaltona.de',
        phone: '+49 40 4322837',
        phoneDisplay: '+49 40 4322837',
        address: 'Norderreihe 59, 22767 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Norderreihe%2059%2C%2022767%20Hamburg',
    },

    social: {
        facebook: 'http://www.autoaltona.de/',
        instagram: '#',
    },

    seo: {
        title: 'Autowerkstatt Altona | Autowerkstatt Hamburg',
        description: 'Autowerkstatt Altona – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.3 von 5 Sternen (54 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Autowerkstatt Altona', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Autowerkstatt Altona – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 54 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Autowerkstatt Altona – Hamburg',
    },

    stats: [
        { value: '54+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Autowerkstatt Altona ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
