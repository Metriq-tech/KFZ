/* ─────────────────────────────────────────────
 *  client-config.ts – Karo Plus Center Hamburg
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KARO',
        fullName: 'Karo Plus Center Hamburg',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'heide@karo.plus',
        phone: '+49 40 5389330',
        phoneDisplay: '+49 40 5389330',
        address: 'Lademannbogen 145, 22339 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Lademannbogen%20145%2C%2022339%20Hamburg',
    },

    social: {
        facebook: 'http://www.karo.plus/',
        instagram: '#',
    },

    seo: {
        title: 'Karo Plus Center Hamburg | Karosseriewerkstatt Hamburg',
        description: 'Karo Plus Center Hamburg – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 4.3 von 5 Sternen (85 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Karo Plus Center Hamburg', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Karo Plus Center Hamburg – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 85 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Karo Plus Center Hamburg – Hamburg',
    },

    stats: [
        { value: '85+', label: 'Bewertungen' },
        { value: '4.3 ★', label: 'Google Score' },
    ...
    about: {
        ...
        description: 'Karo Plus Center Hamburg steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
