/* ─────────────────────────────────────────────
 *  client-config.ts – Karosserie-Meisterbetrieb Stephan Seifert
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KAROSSERIE',
        fullName: 'Karosserie-Meisterbetrieb Stephan Seifert',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: '',
        phone: '+49 40 46882535',
        phoneDisplay: '+49 40 46882535',
        address: 'Humboldtstraße 101, 22083 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Humboldtstra%C3%9Fe%20101%2C%2022083%20Hamburg',
    },
    ...
    seo: {
        title: 'Karosserie-Meisterbetrieb Stephan Seifert | Karosseriewerkstatt Hamburg',
        description: 'Karosserie-Meisterbetrieb Stephan Seifert – Ihr Karosseriewerkstatt in Hamburg.  Jetzt Termin vereinbaren.',
        keywords: ['Karosserie-Meisterbetrieb Stephan Seifert', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Karosserie-Meisterbetrieb Stephan Seifert – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 53 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Karosserie-Meisterbetrieb Stephan Seifert – Hamburg',
    },

    stats: [
        { value: '53+', label: 'Bewertungen' },
        { value: '3.8 ★', label: 'Google Score' },
    ...
    about: {
        ...
        description: 'Karosserie-Meisterbetrieb Stephan Seifert steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
