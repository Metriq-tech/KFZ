/* ─────────────────────────────────────────────
 *  client-config.ts – A. & H. Schwarz Autotechnik GmbH
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'A.',
        fullName: 'A. & H. Schwarz Autotechnik GmbH',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'kfz.schwarz@t-online.de',
        phone: '+49 40 6524160',
        phoneDisplay: '+49 40 6524160',
        address: 'Von-Hein-Straße 20, 22041 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Von-Hein-Stra%C3%9Fe%2020%2C%2022041%20Hamburg',
    },

    social: {
        facebook: 'https://ahschwarzautotechnik.de/',
        instagram: '#',
    },

    seo: {
        title: 'A. & H. Schwarz Autotechnik GmbH | Autowerkstatt Hamburg',
        description: 'A. & H. Schwarz Autotechnik GmbH – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (87 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['A. & H. Schwarz Autotechnik GmbH', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'A. & H. Schwarz Autotechnik GmbH – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 87 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'A. & H. Schwarz Autotechnik GmbH – Hamburg',
    },

    stats: [
        { value: '87+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'A. & H. Schwarz Autotechnik GmbH ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
