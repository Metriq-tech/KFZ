...
export const clientConfig: ClientConfig = {
    ...
    contact: {
        email: 'info@autowerk24.de',
        phone: '+49 40 80791882',
        phoneDisplay: '+49 40 80791882',
        address: 'Olloweg 45 c, 22527 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Olloweg%2045%20c%2C%2022527%20Hamburg',
    },

    social: {
        facebook: 'http://www.autowerk24-hamburg.de/',
        instagram: '#',
    },

    seo: {
        title: 'Autowerk | Autowerkstatt Hamburg',
        description: 'Autowerk – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (116 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Autowerk', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Autowerk – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 116 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Autowerk – Hamburg',
    },

    stats: [
        { value: '116+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Autowerk ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
