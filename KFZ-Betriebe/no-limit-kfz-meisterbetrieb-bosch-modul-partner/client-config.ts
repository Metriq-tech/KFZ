/* ─────────────────────────────────────────────
 *  client-config.ts – No Limit KFZ-Meisterbetrieb Bosch Modul - Partner
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'N',
        brandName: 'NO',
        fullName: 'No Limit KFZ-Meisterbetrieb Bosch Modul - Partner',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@no-limit-kfz-meisterbetrieb.de',
        phone: '+49 40 75692500',
        phoneDisplay: '+49 40 75692500',
        address: 'Rahlstedter Str. 10, 22149 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Rahlstedter%20Str.%2010%2C%2022149%20Hamburg',
    },

    social: {
        facebook: 'http://www.no-limit-kfz-meisterbetrieb.de/',
        instagram: '#',
    },

    seo: {
        title: 'No Limit KFZ-Meisterbetrieb Bosch Modul - Partner | Autowerkstatt Hamburg',
        description: 'No Limit KFZ-Meisterbetrieb Bosch Modul - Partner – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (105 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['No Limit KFZ-Meisterbetrieb Bosch Modul - Partner', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'No Limit KFZ-Meisterbetrieb Bosch Modul - Partner – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 105 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'No Limit KFZ-Meisterbetrieb Bosch Modul - Partner – Hamburg',
    },

    stats: [
        { value: '105+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'No Limit KFZ-Meisterbetrieb Bosch Modul - Partner ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
