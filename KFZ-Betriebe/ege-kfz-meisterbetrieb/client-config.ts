/* ─────────────────────────────────────────────
 *  client-config.ts – EGE KFZ Meisterbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'E',
        brandName: 'EGE',
        fullName: 'EGE KFZ Meisterbetrieb',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'kfzegewerkstatt@gmail.com',
        phone: '+49 176 23702306',
        phoneDisplay: '+49 176 23702306',
        address: 'Gutenbergstraße 59, 22525 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Gutenbergstra%C3%9Fe%2059%2C%2022525%20Hamburg',
    },

    social: {
        facebook: 'http://egekfz.de/',
        instagram: '#',
    },

    seo: {
        title: 'EGE KFZ Meisterbetrieb | Autowerkstatt Hamburg',
        description: 'EGE KFZ Meisterbetrieb – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (6 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['EGE KFZ Meisterbetrieb', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'EGE KFZ Meisterbetrieb – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 6 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'EGE KFZ Meisterbetrieb – Hamburg',
    },

    stats: [
        { value: '6+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'EGE KFZ Meisterbetrieb ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
