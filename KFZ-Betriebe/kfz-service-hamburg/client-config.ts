/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ Service Hamburg
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ',
        fullName: 'KFZ Service Hamburg',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: '',
        phone: '+49 1575 3757893',
        phoneDisplay: '+49 1575 3757893',
        address: 'Geierstraße 21, 22305 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Geierstra%C3%9Fe%2021%2C%2022305%20Hamburg',
    },
    ...
    seo: {
        title: 'KFZ Service Hamburg | Autowerkstatt Hamburg',
        description: 'KFZ Service Hamburg – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (96 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ Service Hamburg', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ Service Hamburg – Autowerkstatt Hamburg',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ Service Hamburg – Hamburg',
    },
    ...
    about: {
        ...
        description: 'KFZ Service Hamburg ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
