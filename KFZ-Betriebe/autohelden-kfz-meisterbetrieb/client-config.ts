/* ─────────────────────────────────────────────
 *  client-config.ts – Autohelden KFZ-Meisterbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AUTOHELDEN',
        fullName: 'Autohelden KFZ-Meisterbetrieb',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'gurbuz@autohelden.de',
        phone: '+49 40 39809898',
        phoneDisplay: '+49 40 39809898',
        address: 'Schimmelmannstraße 141, 22043 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Schimmelmannstra%C3%9Fe%20141%2C%2022043%20Hamburg',
    },

    social: {
        facebook: 'https://www.autohelden.de/',
        instagram: '#',
    },

    seo: {
        title: 'Autohelden KFZ-Meisterbetrieb | Autowerkstatt Hamburg',
        description: 'Autohelden KFZ-Meisterbetrieb – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (60 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Autohelden KFZ-Meisterbetrieb', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Autohelden KFZ-Meisterbetrieb – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 60 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Autohelden KFZ-Meisterbetrieb – Hamburg',
    },

    stats: [
        { value: '60+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Autohelden KFZ-Meisterbetrieb ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
