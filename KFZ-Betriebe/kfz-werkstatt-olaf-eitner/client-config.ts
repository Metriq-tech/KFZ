/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ-Werkstatt Olaf Eitner
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ-WERKST',
        fullName: 'KFZ-Werkstatt Olaf Eitner',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@eitner-kfz.com',
        phone: '+49 40 2196053',
        phoneDisplay: '+49 40 2196053',
        address: 'b. d. Grünen Brücke 53, 20539 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=b.%20d.%20Gr%C3%BCnen%20Br%C3%BCcke%2053%2C%2020539%20Hamburg',
    },

    social: {
        facebook: 'https://eitner-kfz.com/',
        instagram: '#',
    },

    seo: {
        title: 'KFZ-Werkstatt Olaf Eitner | Autowerkstatt Hamburg',
        description: 'KFZ-Werkstatt Olaf Eitner – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (129 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ-Werkstatt Olaf Eitner', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ-Werkstatt Olaf Eitner – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 129 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ-Werkstatt Olaf Eitner – Hamburg',
    },

    stats: [
        { value: '129+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'KFZ-Werkstatt Olaf Eitner ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
