/* ─────────────────────────────────────────────
 *  client-config.ts – Auto Service Zentrum HH Stellingen
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AUTO',
        fullName: 'Auto Service Zentrum HH Stellingen',
    ...
    contact: {
        email: 'info@aszhh.de',
        phone: '+49 40 858089',
        phoneDisplay: '+49 40 858089',
        address: 'Kieler Str. 207, 22525 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Kieler%20Str.%20207%2C%2022525%20Hamburg',
    },

    social: {
        facebook: 'http://www.aszhh.de/',
        instagram: '#',
    },

    seo: {
        title: 'Auto Service Zentrum HH Stellingen | Autowerkstatt Hamburg',
        description: 'Auto Service Zentrum HH Stellingen – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (152 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Auto Service Zentrum HH Stellingen', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Auto Service Zentrum HH Stellingen – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 152 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Auto Service Zentrum HH Stellingen – Hamburg',
    },

    stats: [
        { value: '152+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Auto Service Zentrum HH Stellingen ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
