/* ─────────────────────────────────────────────
 *  client-config.ts – Auto Haake GmbH - Autowerkstatt in Hamburg
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AUTO',
        fullName: 'Auto Haake GmbH - Autowerkstatt in Hamburg',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@autohaake.de',
        phone: '+49 40 562839',
        phoneDisplay: '+49 40 562839',
        address: 'Basselweg 81, 22527 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Basselweg%2081%2C%2022527%20Hamburg',
    },

    social: {
        facebook: 'http://autohaake.de/',
        instagram: '#',
    },

    seo: {
        title: 'Auto Haake GmbH - Autowerkstatt in Hamburg | Autowerkstatt Hamburg',
        description: 'Auto Haake GmbH - Autowerkstatt in Hamburg – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (108 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Auto Haake GmbH - Autowerkstatt in Hamburg', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Auto Haake GmbH - Autowerkstatt in Hamburg – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 108 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Auto Haake GmbH - Autowerkstatt in Hamburg – Hamburg',
    },

    stats: [
        { value: '108+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Auto Haake GmbH - Autowerkstatt in Hamburg ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
