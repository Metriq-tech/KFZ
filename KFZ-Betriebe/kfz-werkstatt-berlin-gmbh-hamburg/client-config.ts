/* ─────────────────────────────────────────────
 *  client-config.ts – Kfz Werkstatt Berlin GmbH - Hamburg
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ',
        fullName: 'Kfz Werkstatt Berlin GmbH - Hamburg',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@kfz-werkstatt-berlin.com',
        phone: '+49 40 27868930',
        phoneDisplay: '+49 40 27868930',
        address: 'Oldenfelder Bogen 7, 22143 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Oldenfelder%20Bogen%207%2C%2022143%20Hamburg',
    },

    social: {
        facebook: 'http://www.kfz-werkstatt-berlin.com/',
        instagram: '#',
    },

    seo: {
        title: 'Kfz Werkstatt Berlin GmbH - Hamburg | Autowerkstatt Hamburg',
        description: 'Kfz Werkstatt Berlin GmbH - Hamburg – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (122 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Kfz Werkstatt Berlin GmbH - Hamburg', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Kfz Werkstatt Berlin GmbH - Hamburg – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 122 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Kfz Werkstatt Berlin GmbH - Hamburg – Hamburg',
    },

    stats: [
        { value: '122+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Kfz Werkstatt Berlin GmbH - Hamburg ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
