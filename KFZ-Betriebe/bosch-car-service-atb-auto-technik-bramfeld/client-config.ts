/* ─────────────────────────────────────────────
 *  client-config.ts – Bosch Car Service ATB Auto Technik Bramfeld
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'B',
        brandName: 'BOSCH',
        fullName: 'Bosch Car Service ATB Auto Technik Bramfeld',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'e.guenes@autotechnik-bramfeld.de',
        phone: '+49 40 67047959',
        phoneDisplay: '+49 40 67047959',
        address: 'Berner Ch 10B, 22175 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Berner%20Ch%2010B%2C%2022175%20Hamburg',
    },

    social: {
        facebook: 'https://www.autotechnik-bramfeld.de/',
        instagram: '#',
    },

    seo: {
        title: 'Bosch Car Service ATB Auto Technik Bramfeld | Autowerkstatt Hamburg',
        description: 'Bosch Car Service ATB Auto Technik Bramfeld – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (336 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Bosch Car Service ATB Auto Technik Bramfeld', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Bosch Car Service ATB Auto Technik Bramfeld – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 336 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Bosch Car Service ATB Auto Technik Bramfeld – Hamburg',
    },

    stats: [
        { value: '336+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Bosch Car Service ATB Auto Technik Bramfeld ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
