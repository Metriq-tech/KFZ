/* ─────────────────────────────────────────────
 *  client-config.ts – Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ-MEISTE',
        fullName: 'Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'anfrage@ihre-kfz-werkstatt-hh.de',
        phone: '+49 173 4467839',
        phoneDisplay: '+49 173 4467839',
        address: 'Försterweg 80, 22525 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=F%C3%B6rsterweg%2080%2C%2022525%20Hamburg',
    },

    social: {
        facebook: 'https://www.ihre-kfz-werkstatt-hh.de/',
        instagram: '#',
    },

    seo: {
        title: 'Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen | Autowerkstatt Hamburg',
        description: 'Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (121 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 121 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen – Hamburg',
    },

    stats: [
        { value: '121+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Kfz-Meister Eder: Autowerkstatt Hamburg Stellingen ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
