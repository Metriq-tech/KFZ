/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ-Meister-Betrieb Frank Gollnick
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        ...
        fullName: 'KFZ-Meister-Betrieb Frank Gollnick',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'bewerbungen@kfz-meister-betrieb.de',
        phone: '+49 40 409162',
        phoneDisplay: '+49 40 409162',
        address: 'Goebenstraße 30-36, 20253 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Goebenstra%C3%9Fe%2030-36%2C%2020253%20Hamburg',
    },

    social: {
        facebook: 'http://www.kfz-meister-betrieb.de/',
        instagram: '#',
    },

    seo: {
        title: 'KFZ-Meister-Betrieb Frank Gollnick | Autowerkstatt Hamburg',
        description: 'KFZ-Meister-Betrieb Frank Gollnick – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.8 von 5 Sternen (143 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ-Meister-Betrieb Frank Gollnick', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ-Meister-Betrieb Frank Gollnick – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 143 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ-Meister-Betrieb Frank Gollnick – Hamburg',
    },

    stats: [
        { value: '143+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'KFZ-Meister-Betrieb Frank Gollnick ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
