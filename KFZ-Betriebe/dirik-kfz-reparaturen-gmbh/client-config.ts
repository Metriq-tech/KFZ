/* ─────────────────────────────────────────────
 *  client-config.ts – Dirik Kfz-Reparaturen GmbH
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'D',
        brandName: 'DIRIK',
        fullName: 'Dirik Kfz-Reparaturen GmbH',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: '',
        phone: '+49 40 75662532',
        phoneDisplay: '+49 40 75662532',
        address: 'Am Veringhof 3, 21107 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Am%20Veringhof%203%2C%2021107%20Hamburg',
    },
    ...
    seo: {
        title: 'Dirik Kfz-Reparaturen GmbH | Karosseriewerkstatt Hamburg',
        description: 'Dirik Kfz-Reparaturen GmbH – Ihr Karosseriewerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (32 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Dirik Kfz-Reparaturen GmbH', 'Karosseriewerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Dirik Kfz-Reparaturen GmbH – Karosseriewerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Karosseriewerkstatt in Hamburg. 32 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Dirik Kfz-Reparaturen GmbH – Hamburg',
    },

    stats: [
        { value: '32+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Dirik Kfz-Reparaturen GmbH steht für professionelle Karosserie- und Lackierarbeiten in Hamburg. Mit modernsten Techniken und höchsten Qualitätsstandards restaurieren wir Ihr Fahrzeug perfekt – von der Smart Repair bis zur Unfallschadensbehebung.',
