/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ Werkstatt Hamburg GmbH
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ',
        fullName: 'KFZ Werkstatt Hamburg GmbH',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'masudasoumma@kfzwerkstatthamburg.de',
        phone: '+49 40 284175260',
        phoneDisplay: '+49 40 284175260',
        address: 'Wendenstraße 197, 20537 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Wendenstra%C3%9Fe%20197%2C%2020537%20Hamburg',
    },

    social: {
        facebook: 'http://www.kfzwerkstatthamburg.de/',
        instagram: '#',
    },

    seo: {
        title: 'KFZ Werkstatt Hamburg GmbH | Autowerkstatt Hamburg',
        description: 'KFZ Werkstatt Hamburg GmbH – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (27 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ Werkstatt Hamburg GmbH', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ Werkstatt Hamburg GmbH – Autowerkstatt Hamburg',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ Werkstatt Hamburg GmbH – Hamburg',
    },
    ...
    about: {
        ...
        description: 'KFZ Werkstatt Hamburg GmbH ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
