/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ SERVICE Kai Hansen Hamburg
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ',
        fullName: 'KFZ SERVICE Kai Hansen Hamburg',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@kfz-service-kai-hansen.de',
        phone: '+49 40 2193939',
        phoneDisplay: '+49 40 2193939',
        address: 'Diagonalstraße 18A, 20537 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Diagonalstra%C3%9Fe%2018A%2C%2020537%20Hamburg',
    },

    social: {
        facebook: 'http://www.kaihansenhh.de/',
        instagram: '#',
    },

    seo: {
        title: 'KFZ SERVICE Kai Hansen Hamburg | Autowerkstatt Hamburg',
        description: 'KFZ SERVICE Kai Hansen Hamburg – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.9 von 5 Sternen (120 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ SERVICE Kai Hansen Hamburg', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ SERVICE Kai Hansen Hamburg – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 120 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ SERVICE Kai Hansen Hamburg – Hamburg',
    },

    stats: [
        { value: '120+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'KFZ SERVICE Kai Hansen Hamburg ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
