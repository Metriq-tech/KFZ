/* ─────────────────────────────────────────────
 *  client-config.ts – Weitze Kfz-Meisterbetrieb
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'W',
        brandName: 'WEITZE',
        fullName: 'Weitze Kfz-Meisterbetrieb',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@kfz-weitze.de',
        phone: '+49 40 546251',
        phoneDisplay: '+49 40 546251',
        address: 'Leverkusenstraße 27, 22761 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Leverkusenstra%C3%9Fe%2027%2C%2022761%20Hamburg',
    },

    social: {
        facebook: 'http://www.kfz-weitze.de/',
        instagram: '#',
    },

    seo: {
        title: 'Weitze Kfz-Meisterbetrieb | Autowerkstatt Hamburg',
        description: 'Weitze Kfz-Meisterbetrieb – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.7 von 5 Sternen (85 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Weitze Kfz-Meisterbetrieb', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Weitze Kfz-Meisterbetrieb – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 85 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Weitze Kfz-Meisterbetrieb – Hamburg',
    },
    ...
    about: {
        ...
        description: 'Weitze Kfz-Meisterbetrieb ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
