/* ─────────────────────────────────────────────
 *  client-config.ts – Oleg Ovcharenko KFZ-Werkstatt
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'O',
        brandName: 'OLEG',
        fullName: 'Oleg Ovcharenko KFZ-Werkstatt',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: '',
        phone: '+49 40 86684081',
        phoneDisplay: '+49 40 86684081',
        address: 'Frankenstraße 24, 20097 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Frankenstra%C3%9Fe%2024%2C%2020097%20Hamburg',
    },
    ...
    seo: {
        title: 'Oleg Ovcharenko KFZ-Werkstatt | Autowerkstatt Hamburg',
        description: 'Oleg Ovcharenko KFZ-Werkstatt – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.3 von 5 Sternen (19 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Oleg Ovcharenko KFZ-Werkstatt', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Oleg Ovcharenko KFZ-Werkstatt – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 19 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Oleg Ovcharenko KFZ-Werkstatt – Hamburg',
    },

    stats: [
        { value: '19+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'Oleg Ovcharenko KFZ-Werkstatt ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
