/* ─────────────────────────────────────────────
 *  client-config.ts – KFZ-SERVICE-WERKSTATT.DE
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'K',
        brandName: 'KFZ-SERVIC',
        fullName: 'KFZ-SERVICE-WERKSTATT.DE',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: 'info@kfz-service-werkstatt.de',
        phone: '+49 40 88189209',
        phoneDisplay: '+49 40 88189209',
        address: 'Haldesdorfer Str. 102a, 22179 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Haldesdorfer%20Str.%20102a%2C%2022179%20Hamburg',
    },

    social: {
        facebook: 'https://www.kfz-service-werkstatt.de/',
        instagram: '#',
    },

    seo: {
        title: 'KFZ-SERVICE-WERKSTATT.DE | Autowerkstatt Hamburg',
        description: 'KFZ-SERVICE-WERKSTATT.DE – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (96 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['KFZ-SERVICE-WERKSTATT.DE', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'KFZ-SERVICE-WERKSTATT.DE – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 96 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'KFZ-SERVICE-WERKSTATT.DE – Hamburg',
    },

    stats: [
        { value: '96+', label: 'Bewertungen' },
    ...
    about: {
        ...
        description: 'KFZ-SERVICE-WERKSTATT.DE ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
