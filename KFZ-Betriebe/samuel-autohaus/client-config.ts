/* ─────────────────────────────────────────────
 *  client-config.ts – Samuel Autohaus
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'S',
        brandName: 'SAMUEL',
        fullName: 'Samuel Autohaus',
        logoImage: '/images/logo.png',
    },

    contact: {
        email: '',
        phone: '+49 491 7662844848',
        phoneDisplay: '+49 491 7662844848',
        address: ', 20459 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=%2C%2020459%20Hamburg',
    },
    ...
    seo: {
        title: 'Samuel Autohaus | Autowerkstatt Hamburg',
        description: 'Samuel Autohaus – Ihr Autowerkstatt in Hamburg. Bewertet mit 5 von 5 Sternen (11 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Samuel Autohaus', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Samuel Autohaus – Autowerkstatt Hamburg',
    ...
    hero: {
        ...
        heroImageAlt: 'Samuel Autohaus – Hamburg',
    },
    ...
    about: {
        ...
        description: 'Samuel Autohaus ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
