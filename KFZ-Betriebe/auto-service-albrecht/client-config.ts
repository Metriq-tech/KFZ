/* ─────────────────────────────────────────────
 *  client-config.ts – Auto-Service Albrecht
...
export const clientConfig: ClientConfig = {
    ...
    branding: {
        logoLetter: 'A',
        brandName: 'AUTO-SERVI',
        fullName: 'Auto-Service Albrecht',
    ...
    contact: {
        email: '',
        phone: '+49 40 7533777',
        phoneDisplay: '+49 40 7533777',
        address: 'Neuhöfer Str. 23, 21107 Hamburg',
        mapsUrl: 'https://maps.google.com/?q=Neuh%C3%B6fer%20Str.%2023%2C%2021107%20Hamburg',
    },
    ...
    seo: {
        title: 'Auto-Service Albrecht | Autowerkstatt Hamburg',
        description: 'Auto-Service Albrecht – Ihr Autowerkstatt in Hamburg. Bewertet mit 4.6 von 5 Sternen (29 Bewertungen). Jetzt Termin vereinbaren.',
        keywords: ['Auto-Service Albrecht', 'Autowerkstatt Hamburg', 'KFZ Werkstatt Hamburg', 'Autowerkstatt Hamburg'],
        ogTitle: 'Auto-Service Albrecht – Autowerkstatt Hamburg',
        ogDescription: 'Ihr zuverlässiger Autowerkstatt in Hamburg. 29 positive Bewertungen.',
    ...
    hero: {
        ...
        heroImageAlt: 'Auto-Service Albrecht – Hamburg',
    },

    stats: [
        { value: '29+', label: 'Bewertungen' },
        { value: '4.6 ★', label: 'Google Score' },
    ...
    about: {
        ...
        description: 'Auto-Service Albrecht ist Ihre zuverlässige KFZ-Werkstatt in Hamburg. Als erfahrener Meisterbetrieb reparieren und warten wir Fahrzeuge aller Hersteller – schnell, transparent und zu fairen Preisen.',
